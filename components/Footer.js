export default function Footer() {
    return (
        <div className="bg-gray-900 mt-8">      
            <div className="flex justify-center"><a rel="noreferrer" target="_blank" href="mailto:me@gmarr.com" className="text-gray-100 font-bold pt-5 hover:underline hover:cursor-pointer">me@gmarr.com</a></div>
